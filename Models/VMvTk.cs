...
public partial class VMvTk
{
    ...
    public decimal? ChasifaMatbeaPiruk { get; set; }
    ...
    public int? SugYitra { get; set; }

    public decimal? AchuzMenayutMediniut { get; set; }

    public string MedinaNischeret { get; set; } = null!;

    public decimal? ChasifaHov { get; set; }

    public string? Derug { get; set; }

    public int? Count { get; set; }

    public string? HieTatAfikTeur5 { get; set; }

    public string? HieTatAfikTeur4 { get; set; }

    public string? HieTatAfikTeur3 { get; set; }

    public string? HieTatAfikTeur2 { get; set; }

    public string? HieTatAfikTeur1 { get; set; }

    public string? MachshirNb { get; set; }
